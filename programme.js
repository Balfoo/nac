...
var produits = new Array();
  ...
  produits["Mug"] = ["Mug", "25", "inusable", "0"];
  produits["Ensemble de stylos"] = ["Ensemble de stylos", "75", "Indispensable en réunion", "0"];
  produits["Chemise"] = ["Chemise", "35", "aérer", "0"];
  produits["Sac"] = ["Sac", "35", "Pratique", "0"];
  produits["Jupe"] = ["Jupe", "15", "douse et 100% coton", "0"];
  produits["Photo Souvenir"] = ["Photo Souvenir", "20", "Magnifique", "0"];
  produits["Peluche"] = ["Peluche", "40", "Très doux", "0"];
